                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6">
                            <div className="ms-3 flex items-center relative">
                                <Link href={route('levels.index')}
                                    className='px-3 py-2 text-sm leading-4 font-medium text-gray-500 border border-transparent rounded-md mr-1 hover:border-gray-400 hover:text-gray-700 transition ease-in-out duration-150'>
                                    Levels
                                </Link>
