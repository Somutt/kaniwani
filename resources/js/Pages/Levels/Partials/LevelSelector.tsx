                    ...
                    <li key={level.id} className="mb-2" >
                        <div className="relative flex items-center z-10">
                            ...
                            <Link 
                                ...
                                as="button" 
                                method="delete"
                                className="p-0.5 bg-red-400 border-2 border-l-0 border-transparent hover:cursor-pointer hover:border-white">
                                x
                            </Link>
                        </div>
                        <div className="flex items-center">
                            <Link
                                ...
                                as="button"
                                method="post"
                                className="relative -top-0.5 p-1 bg-red-400 border-2 border-t-0 border-transparent rounded ml-2 hover:cursor-pointer hover:border-white">
                                Add Stage
                            </Link>
